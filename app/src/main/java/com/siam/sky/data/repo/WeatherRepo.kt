...
class WeatherRepo(
    ...
    fun getHourlyForecast(lat: Double, lon: Double, city: String, language: String, unit: String): Flow<ResponseState<HourlyForecastResponse>> = flow {
        if (networkMonitor.isConnected()) {
    ...
    fun getDailyForecast(lat: Double, lon: Double, city: String, language: String, cnt: Int = 7, unit: String): Flow<ResponseState<DailyForecastResponse>> = flow {
        if (networkMonitor.isConnected()) {
